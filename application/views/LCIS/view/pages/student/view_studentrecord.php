		...
		<div class="panel-body">
			...
			<div class=" pull-left">
				<div class="col-md-12 pad-bottom-10">
					...
					<strong class="strong">2014-01268</strong>
				</div>
				<div class="col-md-12 pad-bottom-10">
					<strong class="strong">Name 			: </strong>
					<strong class="strong">MICAHEL LAUDICO</strong>
				</div>
				...
				<div class="col-md-12 pad-bottom-10">
					...
					<strong class="strong">First Year</strong>
				</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><strong>Final Grades</strong></td>
						<td><strong>Re-Exam</strong></td>
