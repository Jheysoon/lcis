<div class="col-md-3"></div>
	<div class="col-md-9 body-container">
		...
		<div class="table-responsive">
				<table class="table table-bordered">
					<tr>
						<th colspan="2">FULL PAYMENT OPTION: </th>
						<th class="tblNum"></th>
						<th colspan="3">INSTALLMENT OPTION:</th>
						<th class="tblNum"></th>
					</tr>
					<tr>
						<td colspan="2">LESS 10% ON TUITION</td>
						<td class="tblNum">(965.12)</td>
						<th colspan="3">ENROLMENT DUES BREAKDOWN</th>
						<th class="tblNum"></th>
					</tr>
					<tr>
					...
					<tr>
						<th colspan="2">NET DUE ON FULL PAYMENT</th>
						<th class="tblNum">11,230.83</th>
					...
					<tr>
						<td colspan="2"></td>
						<td class="tblNum"></td>
						<th colspan="3">NET DUE UPON ENROLMENT</th>
						<th class="tblNum">3,714.99</th>
					</tr>
