<div class="col-md-3"></div>
	<div class="col-md-9 body-container">
		...
		<div class="panel-heading">
			<h4>Tuition Assesment Display</h4>
		</div>
		...
		<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						<th class="tblNum input-enrol">TOTAL SUBJECTS</th>
						<th class="tblNum input-enrol">10</th>
						<th class="tblNum input-enrol">TOTAL UNITS</th>
						<th class="tblNum input-enrol">29</th>
						<th class="tblNum input-enrol" input-enrol colspan="3">GROSS TOTAL THIS SEMESTER</th>
						<th class="tblNum input-enrol">12,195.95</th>
					</tr>
				</table>
			</div>
			</div>
