          ...
          <li class="list-group-item">
              <a class="menu">
               <span class="glyphicon glyphicon-th-list"></span>&nbsp; &nbsp; Student Information Management
              </a>
          ...
          <li class="list-group-item">
              <a class="menu" href="<?php //echo base_url('registrar_manageUsers'); ?>">
                  <span class="glyphicon glyphicon-list"></span>&nbsp; &nbsp; Reports
              </a>
              <ul class="sub-menu">
                <li class="li-sub-menu">
                    <a class="menu" href="">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp; &nbsp; Transcript of Records
                    </a>
                </li>
                <li class="li-sub-menu">
                    <a class="menu" href="">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp; &nbsp; Form 9
                    </a>
                </li>
                <li class="li-sub-menu">
                    <a class="menu" href="">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp; &nbsp; Certification with Honors
                    </a>
                </li>
                <li class="li-sub-menu">
                    <a class="menu" href="">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp; &nbsp; Certification of Enrollment
                    </a>
                </li>
                <li class="li-sub-menu">
                    <a class="menu" href="">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp; &nbsp; Certification of Units Earned
                    </a>
                </li>
                <li class="li-sub-menu">
                    <a class="menu" href="">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp; &nbsp; Good Moral Character
                    </a>
                </li>
                <li class="li-sub-menu">
                    <a class="menu" href="">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp; &nbsp; Diploma
                    </a>
                </li>
              </ul>
          </li>
