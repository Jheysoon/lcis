              ...
              <li class="list-group-item"><a class="menu" href="index.php?page=deanTeachingLoad">
               <span class="glyphicon glyphicon-tasks"></span>&nbsp; &nbsp; Teaching Load</a></li>
              ...
              <li class="list-group-item"><a class="menu" href="index.php?page=deanStudentGrading">
               <span class="glyphicon glyphicon-file"></span>&nbsp; &nbsp; Class Record - Student Grading</a></a></li>
              <li class="list-group-item"><a class="menu" href="index.php?page=deanAttestGrade">
               <span class="glyphicon glyphicon-cog"></span>&nbsp; &nbsp; Incomplete Grading</a></li>

              <li class="list-group-item"><a class="menu">
               <span class="glyphicon glyphicon-file"></span>&nbsp; &nbsp; System Parameters</a>
                  <ul class="sub-menu">
                    <li class="li-sub-menu"><a class="menu" href="index.php?page=updateSystemValue">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp; &nbsp; Course</a></li>
                    <li class="li-sub-menu"><a class="menu" href="index.php?page=listSchool">
