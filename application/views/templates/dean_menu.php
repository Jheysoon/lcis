<!--               
              ...
              <li class="list-group-item"><a class="menu" href="index.php?page=deanTeachingLoad">
               <span class="glyphicon glyphicon-tasks"></span>&nbsp; &nbsp; Teaching Load Management</a></li>
              ...
              <li class="list-group-item"><a class="menu" href="index.php?page=deanStudentGrading">
               <span class="glyphicon glyphicon-file"></span>&nbsp; &nbsp; Student Grading</a></a></li>
              <li class="list-group-item"><a class="menu" href="index.php?page=deanAttestGrade">
               <span class="glyphicon glyphicon-cog"></span>&nbsp; &nbsp; Attest Teacher's Student Grading</a></li>
              <li class="list-group-item"><a class="menu" href="index.php?page=deanAttestCompletion">
               <span class="glyphicon glyphicon-cog"></span>&nbsp; &nbsp; Attest Completion INC Subject</a></li>
