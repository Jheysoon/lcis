<div class="col-md-3"></div>
	<div class="col-md-9 body-container">
		...
		<div class="panel-heading search">
			<div class="col-md-6">
				<h4>Summary of Student Evaluation</h4>
			</div>
		</div>
		...
		<div class="table-responsive">
			<form class="form" role="form">
				<table class="table table-bordered table-hover">
					...
					<tr>
						<td></td>
						<th class="tblNum td-total">TOTAL UNITS</th>
						<th class="tblNum td-total">32</th>
						<td></td>
						<th class="tblNum td-total">TOTAL SUBJECTS</th>
						<th class="tblNum td-total">10</th>
						<td></td>
					</tr>
				</table>
				</form>
				</div>
				<button type="button" class="btn btn-success pull-right">Save Evaluation</button>
		</div>
	</div>
</div>