	...
	<div class="panel p-body">
		...
		<div class="panel-body">
            ...
            <?php
                ...
                $cl = $this->db->query("SELECT b.code as code,b.descriptivetitle as title,a.id as cl_id,coursemajor,instructor FROM tbl_classallocation a, tbl_subject b WHERE a.subject = b.id AND academicterm = {$systemVal['currentacademicterm']}")->result_array();
             ?>
             <table class="table">
				 <caption>
					 <strong>
