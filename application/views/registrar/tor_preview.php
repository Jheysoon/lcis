...
<html>
    ...
    <div class="table1">
        <table class="tbl-bordered">
            ...
            <?php
            $enrol = $this->tor->getEnrolment($pid);
            $sch = '';
            foreach ($enrol as $key => $val) { extract($val);
                if ($sch != $val['school']) {
                    ?>
                        <tr>
                            <td colspan="5"><strong><?php echo $val['firstname']; ?></strong></td>
                        </tr>
                    <?php
                }
                    ?>
                        <tr>
                            <td class="center" colspan="5"><?php echo $val['shortname']." SY : ". $val['systart']."-".$val['syend']; ?></td>
                        </tr>
                    <?php
                    $sch = $val['school'];
                    ...
                    foreach ($grade as $key2 => $val2) {
                        ...
                        <tr>
                            ...
                            <td class="center no-line"><?php echo $rgrade; ?></td>
    ...
    <div class="table2">
        <table>
            <tr>
                ...
                <td width="50px" class="center underline"></td>
            </tr>
        </table>
    </div>
    </div>
