		...
		<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td>OPEN</td>
						<td><a class="a-table label label-info" href="index.php?page=editServiceRequest">Edit<span class="glyphicon glyphicon-pencil"></span></a></td>
					</tr>
					<tr>
						<td>2011-000151</td>
						<td>ELLEN TAN</td>
				...
				<button class="btn btn-success pull-right">New Service Request</button>
			</div>
		</div>
		</div>
	</div>
