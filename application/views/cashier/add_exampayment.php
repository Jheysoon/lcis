		...
		<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td class="tblNum input-enrol">1,000.00</td>
					</tr>
					<tr>
						<td class="input-enrol">OFFICIAL RECEIPT NUMBER: </td>
						<td><strong><input class="form-control input-enrol" type="numeric" name="payment" placeholder="enter amount" value="                                              15015"></strong>
					</tr>
					<tr>
